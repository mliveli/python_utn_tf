...
# filtrar multiples alquileres por el mismo auto misma fecha en boton disponibilidad
# Conectar alta y modificacion con boton modificar
    ...
    if test_fechas():
        ...
        for i in range(dias + 1):
            fechas_temporales.append(
                (f_inicio + timedelta(days=i)).strftime("%Y-%m-%d")
            )
...
def f_boton_reservar(con, tree):
    print(type(e_telefono.get()), "    ", e_telefono.get())
    ultimo_id = 0

    if not test_telefono(e_telefono.get()):
        return

    if not test_disponibilidad():
        return
...
# ********************************************************************
def test_fechas():
    if fecha_inicio.get() > fecha_fin.get():
        messagebox.showinfo(
...
def test_disponibilidad():
    f_boton_disponibilidad()
    color_fondo = (marcador_disponibilidad.config())["background"][-1]
    print("<*******> ", type(color_fondo), color_fondo, "<  /  >")
    if color_fondo == "green":
        return True
    else:
        messagebox.showinfo(
...
<*******>   {'background': ('background', 'background', 'Background', <string object: 'SystemWindow'>, 'green'), 'bd': ('bd', '-borderwidth'), 'bg': ('bg', '-background'), 'borderwidth': ('borderwidth', 'borderWidth', 'BorderWidth', <string object: '1'>, 1), 'cursor': ('cursor', 'cursor', 'Cursor', <string object: 'xterm'>, 'xterm'), 'disabledbackground': ('disabledbackground', 'disabledBackground', 'DisabledBackground', <string object: 'SystemButtonFace'>, 'SystemButtonFace'), 'disabledforeground': ('disabledforeground', 'disabledForeground', 'DisabledForeground', <string object: 'SystemDisabledText'>, 'SystemDisabledText'), 'exportselection': ('exportselection', 'exportSelection', 'ExportSelection', 1, 1), 'fg': ('fg', '-foreground'), 'font': ('font', 'font', 'Font', <string object: 'TkTextFont'>, 'TkTextFont'), 'foreground': ('foreground', 'foreground', 'Foreground', <string object: 'SystemWindowText'>, 'SystemWindowText'), 'highlightbackground': ('highlightbackground', 'highlightBackground', 'HighlightBackground', <string object: 'SystemButtonFace'>, 'SystemButtonFace'), 'highlightcolor': ('highlightcolor', 'highlightColor', 'HighlightColor', <string object: 'SystemWindowFrame'>, 'SystemWindowFrame'), 'highlightthickness': ('highlightthickness', 'highlightThickness', 'HighlightThickness', <string object: '0'>, 0), 'insertbackground': ('insertbackground', 'insertBackground', 'Foreground', <string object: 'SystemWindowText'>, 'SystemWindowText'), 'insertborderwidth': ('insertborderwidth', 'insertBorderWidth', 'BorderWidth', <string object: '0'>, 0), 'insertofftime': ('insertofftime', 'insertOffTime', 'OffTime', 300, 300), 'insertontime': ('insertontime', 'insertOnTime', 'OnTime', 600, 600), 'insertwidth': ('insertwidth', 'insertWidth', 'InsertWidth', <string object: '2'>, 2), 'invalidcommand': ('invalidcommand', 'invalidCommand', 'InvalidCommand', '', ''), 'invcmd': ('invcmd', '-invalidcommand'), 'justify': ('justify', 'justify', 'Justify', <string object: 'left'>, 'left'), 'readonlybackground': ('readonlybackground', 'readonlyBackground', 'ReadonlyBackground', <string object: 'SystemButtonFace'>, 'SystemButtonFace'), 'relief': ('relief', 'relief', 'Relief', <string object: 'sunken'>, 'sunken'), 'selectbackground': ('selectbackground', 'selectBackground', 'Foreground', <string object: 'SystemHighlight'>, 'SystemHighlight'), 'selectborderwidth': ('selectborderwidth', 'selectBorderWidth', 'BorderWidth', <string object: '0'>, 0), 'selectforeground': ('selectforeground', 'selectForeground', 'Background', <string object: 'SystemHighlightText'>, 'SystemHighlightText'), 'show': ('show', 'show', 'Show', '', ''), 'state': ('state', 'state', 'State', <string object: 'normal'>, 'normal'), 'takefocus': ('takefocus', 'takeFocus', 'TakeFocus', '', ''), 'textvariable': ('textvariable', 'textVariable', 'Variable', '', ''), 'validate': ('validate', 'validate', 'Validate', <string object: 'none'>, 'none'), 'validatecommand': ('validatecommand', 'validateCommand', 'ValidateCommand', '', ''), 'vcmd': ('vcmd', '-validatecommand'), 'width': ('width', 'width', 'Width', 20, 20), 'xscrollcommand': ('xscrollcommand', 'xScrollCommand', 'ScrollCommand', '', '')} <  /  >
re.compile('(\\b[0-9][0-9]{9,14}\\b)')
...
vsb.place(x=330 + 500 + 2, y=55, height=200 + 20)
