...
# ****************************************************************
def f_boton_baja():  # actualizar base de datos
    global id_reserva
    global reserva
    item = tree.focus()
    tree.delete(item)
...
# ****************************************************************
def f_boton_modificar():  # actualizar base de datos
    global id_reserva
    item = tree.focus()
    print(item)
...
# ****************************************************************
def f_boton_salir():  # actualizar base de datos
...
# ****************************************************************
def bind_accion(evt):  # actualizar base de datos
    global id_reserva
    global reserva
    item = tree.focus()
